...
let phrase =""
let Steeven = new Person("steeven","Je suis la pour la disparition du vase. Expliquez-moi plus en détail ce que vous savez s'il vous plaît.","Bonjour, comme vous le savez un vase a disparu je l'ai su par Julietta je vous conseille d'aller la voir.","Connaissez vous bien Julietta ?","Pas vraiment, mais j'ai un petit doute sur elle.","J'ai couru suite à votre appel, dites moi ce que vous savez.","Comme on vous la dit un vase a disparu, je crois que c'est Julietta de l'accueil qui m'en a parlé.","Vous qui êtes le directeur vous ne savez rien d'autre ?","je vous conseille d'aller voir Julietta, c'est la commère du musée, elle pourra vous en dire plus.","je ne sais pas",[])
let Roseta = new Person("roseta","Bonjour, comment allez-vous aujourd'hui ?","Ça peut aller, j'ai connu des jours meilleurs.","Vous avez l'air stresser, que vous arrive t'il ?","Hier je n'étais pas bien j'ai perdu ma bague de fiançailles, j'ai eu la peur de ma vie.","je suis la personne qui va enquêter sur la disparition du vase, vous étiez sur les lieux hier ? ","Oui je travaillais hier, j'étais en train de trier les archives quand d'un seul coup, j'ai entendu un bruit dans la salle des vases.","Qui pourrais en savoir plus sur la disparition du vase ?","C'est Logan qui est en charge de la sécurité je vous conseille d'aller le voir.","Je suis désolé je n'ai pas le temps... J'ai une tonne de paperasse a trier",[])
let John = new Person("john","pourquoi êtes vous repasser au musée hier soir ?","Je suis repassé au travail après une soirée car j'avais oublié quelque chose !","Vous n'avez rien vu de suspect ?","En repartant j'ai croisé Rosetta qui était à la salle des archives. Elle avait l'air en panique.","Avez vous vu le vase ?","Non désolé... mes souvenir sont assez... approximatif de la soirée d'hier...","pouvez vous me dire ce que vous savez par rapport à la disparition du vase ?","Hier je suis repassé au boulot, j'avais oublié mes clés de maison, en passant j'ai vu Rosetta, elle avait l'air stressée je n'ai pas compris pourquoi.","Je ne peut pas vous aider... j'ai vraiment mal à la tête...",[])
let Julietta = new Person("julietta","Bonjour, je suis le détective chargé de l'enquête, pouvez vous m'aider ?","Bonjour, bien-sûr.","Que savez vous sur le reste du personnel?","Pas grand chose je suis nouvelle... Mais John a l'air d'avoir un sacré coup de bouteille","Que faisiez vous hier soir ?","j'étais au travail toute la soirée à l'accueil","Avez-vous vue ou entendue quelque chose de suspect hier ?","j'ai vu John revenir, il avait l'air saoul.","Je ne peut pas vous aider, je suis occupée ",[])
let Logan = new Person( "logan","Bonjour, je suis la pour le vase qui a disparu","Quoiiii ? Un vase a disparu","Que pouvez vous me dire à propos de la soirée d'hier  ?","Rien de spécial, j'ai fait des rondes toute la nuit et je n'ai rien vu. ","Que faisiez vous hier soir ?","Je faisais des rondes dehors.","auriez vous un conseil à me donner au sujet de la disparition du vase ?","Allez voir à la salle de réparation des œuvres ! ","désolé mais les visiteurs affluent... je n'ai vraiment pas le temps de vous aider",[])
...
function introduction() {
    ...
    var chaine = "Hier soir, un objet de valeur a disparu, il y a aucune trace sur les caméras de surveillance, les alarmes ne se sont pas enclenchées.<br> Votre mission si vous l'acceptez est de résoudre ce mystère."; 
...
function phraseRosetta() {
    document.getElementById("nomPiece").innerHTML = "Salle des archive"
    document.getElementById("epilogue").style.display = "none";
    inter = "Roseta";
...
function resetfin() {
   ...
   function epilogue(){
       ...
       var chaine = "dans la salle de restauration, vous surprenez un homme avec le vase disparu a la main... Il dis: " + "<br>" + localStorage.getItem("phrase") + "<br>" + "Que faite vous ?"; 
       var nb_car = chaine.length; 
       var tableau = chaine.split("");
       texte = new Array;
       var txt = '';
...
function epilogue2 (){
    document.body.style.backgroundImage = "url('image/flou.png')";
    var chaine = "vous laisser partir l'homme et profiter de ces quelques instant a explorer la salle de restauration des oeuvres passer un moment, vous decider de sortir et là un homme vous interpelle... il vous demande pourquoi vous avez le vase a la main... que dites vous ?"; 
    var nb_car = chaine.length; 
    var tableau = chaine.split("");
    texte = new Array;
    var txt = '';
...
function epilogue3(){
        ...
        document.body.style.backgroundImage = "url('image/flou.png')";
        var chaine = "vous appeller la securité et vous enfermé l'homme dans une salle adjacente a la salle de restauration... En attendant, vous profitez de ces quelques instant a explorer la salle de restauration des oeuvres passer un moment, vous decider de sortir et là un homme vous interpelle... il vous demande pourquoi vous avez le vase a la main... que dites vous ?"; 
        var nb_car = chaine.length; 
        var tableau = chaine.split("");
        texte = new Array;
        var txt = '';
